...
versionMaj=$(ls postman*.tar.gz | awk -F '-' '{ print $2 }' | awk -F '.' '{ print $1 }')
versionMin=$(ls postman*.tar.gz | awk -F '-' '{ print $2 }' | awk -F '.' '{ print $2 }')
versionRev=$(ls postman*.tar.gz | awk -F '-' '{ print $2 }' | awk -F '.' '{ print $3 }')
